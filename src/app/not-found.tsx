...
export default function NotFound() {
  return (
    <>
      {/* Hide header using inline styles as fallback */}
      ...
      <main className="relative h-screen flex items-center justify-center text-center text-stone-800 dark:text-stone-100 overflow-hidden dark-background hide-header">
        {/* Background Image */}
